...
This gate checks the guide's own bibliography and cross-references. A defect in
the guide is a failure; a defect quoted from the paper is evidence to report.
Undefined citations belong to the guide and fail its build.
"""
