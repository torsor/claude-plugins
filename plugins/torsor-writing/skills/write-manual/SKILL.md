---
name: write-manual
description: Create a styled user's manual for a project — LaTeX source with HTML, PDF, EPUB, and Markdown output — following the torsor design and the direct, conversational prose style used in the thing manual.
...
4. **Shared mechanics — the commons.** The family scaffold (directory layout, Makefile,
   ...
   toolchain misbehaves (a build reporting success on a failed or stale PDF, HTML/EPUB math
